...
//
const BotName = 'BOT RISKOY'; // Nama Bot Whatsapp
const instagramlu = 'https://www.instagram.com/hermawanrisky02/'; // Nama Instagramlu cok
const whatsapplu = '0858-0363-9392'; // Nomor whatsapplu cok
const kapanbotaktif = 'SETERAH RISKOY Jam'; // Kapan bot lu aktif
const grupch1 = 'https://chat.whatsapp.com/JYNCOeG5OGcDanlqtIPuJj'; // OFFICIAL GRUP LU 1
const grupch2 = 'https://chat.whatsapp.com/IjDnrLfLoJh6a20EdW7TDm'; // OFFICIAL GRUP LU 2
//
const
{
   WAConnection,
...
conn.on('qr', qr =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] Scan kode qr mu ok`);
});
...
conn.sendMessage(id, 'Waalaikumsalam, ada yang bisa saya bantu? kalo bingung ketik #help om..' ,MessageType.text);
}
else if (text == 'salam'){
conn.sendMessage(id, 'Waalaikumsalam, ada yang bisa saya bantu? kalo bingung ketik #help ya om..' ,MessageType.text);
}
...
conn.sendMessage(id, 'Ya?, ada yang bisa saya bantu? kalo bingung ketik #help ya om..' ,MessageType.text);
}
else if (text == 'P'){
conn.sendMessage(id, 'Ya?, ada yang bisa saya bantu? kalo bingung ketik #help ya om..' ,MessageType.text);
}
